...
const messages = [
 ...
 yesButton.addEventListener('click',()=>{
    document.getElementById('girl').src = "https://hips.hearstapps.com/hmg-prod/images/scarlett-johansson-13671719-1-402.jpg?resize=1200:*";
    yesButton.textContent = "Yayyyy!!!!!";
